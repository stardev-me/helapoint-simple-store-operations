      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 animate-slide-up" style={{ animationFillMode: 'both' }}>
            ...
            <span className="gradient-text">everyday retail</span>
          </h2>
          ...
          <TabsList className="flex flex-wrap justify-center gap-2 bg-transparent h-auto mb-8">
            {features.map((feature) => (
              <TabsTrigger
                key={feature.id}
                value={feature.id}
                className="glass data-[state=active]:bg-primary data-[state=active]:text-primary-foreground px-4 py-2 rounded-full hover:scale-105 transition-all duration-300 text-sm font-medium"
              >
                ...
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div className="animate-slide-in-left" style={{ animationFillMode: 'both' }}>
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div className="glass px-3 py-1 rounded-full text-xs font-medium text-primary">
                        {feature.details[0].split(' ')[0]}
                      </div>
                    </div>
                  ...
                  <div className="relative rounded-2xl overflow-hidden min-h-[300px] group animate-slide-in-right" style={{ animationFillMode: 'both' }}>
                    <img 
                      src={feature.image} 
                      alt={feature.title}
                    ...
                    {/* Floating badge */}
                    <div className="absolute bottom-4 left-4 glass-strong rounded-lg px-3 py-2 animate-float">
