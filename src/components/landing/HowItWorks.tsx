          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="relative flex-shrink-0">
                <div className="w-12 h-12 bg-primary rounded-full flex items-center justify-center shadow-lg group-hover:scale-110 transition-all duration-500">
                  <step.icon className="w-6 h-6 text-primary-foreground" />
                </div>
              </div>

              {/* Content */}
              <div className="flex-1 pt-1 glass-strong rounded-xl p-4 group-hover:shadow-lg transition-all duration-300">
